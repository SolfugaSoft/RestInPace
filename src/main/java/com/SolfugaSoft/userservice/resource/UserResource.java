...
public class UserResource {
    ...
    @GetMapping("/getall")
        ...
        ResponseEntity<List<User>> userResponse = restTemplate.exchange("http://localhost:8300/rest/db/all", HttpMethod.GET, null, new ParameterizedTypeReference<List<User>>() {});
